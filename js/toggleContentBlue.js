$('body').on('click', '.expandingContentClosed .headingexpandingBlue', function(event){
  ...
  $(that).children('.expandingSubText').animate({
		...
		that.getElementsByClassName("headingexpandingBlue")[0].getElementsByTagName("img")[0].src = "../images/slidingContent/minus.png";
	  });
});

$('body').on('click', '.expandingContentOpen .headingexpandingBlue', function(event){
  var that = this.parentNode;
  ...
  $(that).children('.expandingSubText').animate({
		...
		that.getElementsByClassName("headingexpandingBlue")[0].getElementsByTagName("img")[0].src = "../images/slidingContent/plus.png";
	  });
});
